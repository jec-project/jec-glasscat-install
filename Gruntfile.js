/*!
 * JEC GlassCat Install Gruntfile.js
...
/*
 * Provides tasks for building and testing the jec-glasscat-install project.
 */
module.exports = function(grunt) {
  ...
  grunt.config("typedoc", {
    doc: {
      ...
      options: {
        ...
        readme: "README.md",
        name: "JEC GlassCat Install Project",
        exclude: "**/*Test*.ts"
      }
    }
  });
  ...
  //--> Task: builds the "jec-glasscat-install" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-glasscat-install" API documentation:
